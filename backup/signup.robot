*** Settings ***
Documentation        Cenários de testes do cadastro dos usuários

Resource             ../resources/base.resource

# Suite Setup          Log    Tudo aqui ocorre antes de todos os testes
# Suite Teardown       Log    Tudo aqui ocorre depois de todos os testes
